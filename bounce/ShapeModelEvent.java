...
public class ShapeModelEvent {
	 ...
	 */
	public static ShapeModelEvent makeShapeAddedEvent(Shape shapeAdded, ShapeModel source) {
	 ...
	 * @param source the ShapeModel object that fires the event.
	 */
	public static ShapeModelEvent makeShapeRemovedEvent(Shape shapeRemoved, NestingShape formerParent, int index, ShapeModel source) {
		return new ShapeModelEvent(EventType.ShapeRemoved, shapeRemoved, formerParent, index, source);
	}
	 ...
	 * @param source the ShapeModel object that fires the event.
	 */
	public static ShapeModelEvent makeShapeMovedEvent(Shape shapeMoved, ShapeModel source) {
